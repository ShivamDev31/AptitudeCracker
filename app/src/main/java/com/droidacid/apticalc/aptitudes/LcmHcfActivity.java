 ...
 */
public class LcmHcfActivity extends BaseActivity implements OnClickListener {
        ...
        switch (v.getId()) {
            case R.id.b_apti_Lcm:
                try {
                    ...
                    d.setNegativeButton("Ok", (dialog, which) -> dialog.cancel());
                    d.show();
                }
                break;
            case R.id.bClear:
